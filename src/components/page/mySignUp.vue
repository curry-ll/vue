<template>
  <div class="mySignUp">
    ...
    >
    <div class="uint" v-for="(item,index) in list" :key="index" @click="activityDetailSign(item.activity_id)">
      <div class="unit-wrap">
        <div class="unit-left">
        <h5>{{item.title}}</h5>
...
export default {
  ...
  methods: {
    ...
    activityDetailSign (id) {
      this.$router.push({ path: '/activityDetailSign', query: {id: id} })
    },
    updateDate () {
      var parame = {
        page: this.page,
